...
// Entidad de Room que representa una receta de dieta para mascotas
@Entity(tableName = "Receta")
public class Receta {
    private static final String TAG = "DEBUG_RECETA_MODEL";

    @PrimaryKey(autoGenerate = true)
    private int id_receta;
    private String nombre_receta;
    private String instrucciones;
    private int tiempo_preparacion; // En minutos
    private String imagen_url;

    // Constructor que registra la creación de una receta, con log para seguimiento
    public Receta(String nombre_receta, String instrucciones, int tiempo_preparacion, String imagen_url) {
        ...
        Log.d(TAG, "Instancia Receta creada: " + nombre_receta +
                " (Tiempo: " + tiempo_preparacion + " min)");
    }
